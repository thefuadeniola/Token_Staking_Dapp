      ...
      <div className="row">
        <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-1 order-lg-4 order-xl-1">
          ...
          <p className="footer__tagline">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Provident aliquam exercitationem cumque ratione expedita quia vel fugiat, repudiandae ullam dignissimos. 
          </p>
        </div>
        ...
        <div className="col-12">
          <div className="footer__content">
            ...
            <small className="footer__copyright">
              &copy; CryptoKing, 2024, Created by <a href="#" target="_blank">@theblockchaincoders</a>
            </small>
          </div>
        </div>
      </div>
